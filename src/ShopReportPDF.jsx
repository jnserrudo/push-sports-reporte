...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', borderBottomWidth: 2, borderBottomColor: '#000000', paddingBottom: 6, marginBottom: 10 },
  logoMain: { fontSize: 48, fontFamily: 'Helvetica-Bold', fontWeight: 'black', letterSpacing: -2, textTransform: 'uppercase', lineHeight: 1, color: '#000000' },
  ...
  tableHeader: { flexDirection: 'row', borderBottomWidth: 2, borderBottomColor: '#000000', paddingBottom: 4, marginBottom: 4, alignItems: 'center' },
  headerText: { fontSize: 8, color: '#1F2937', textTransform: 'uppercase', fontWeight: 'bold', letterSpacing: 1 },
  colImg: { width: '50%', justifyContent: 'center', alignItems: 'center', paddingRight: 10 },
  colProducto: { width: '30%', paddingRight: 10 },
  ...
  rowTextMarca: { fontSize: 7, color: '#374151', textTransform: 'uppercase', marginTop: 2, fontWeight: 'bold' },
  rowTextStockGroup: { fontSize: 6.5, color: '#1F2937', textTransform: 'uppercase', marginBottom: 1 },
  rowTextStockLabel: { fontFamily: 'Helvetica-Bold', color: '#4B5563' },
  rowTextStockValue: { fontFamily: 'Helvetica-Bold', color: '#007A99' },
  rowTextStockTotalValue: { fontFamily: 'Helvetica-Bold', color: '#000000' },
  rowTextPrecio: { fontSize: 10, fontFamily: 'Helvetica-Bold', color: '#000000', fontWeight: 'bold' },
  footer: { marginTop: 'auto', paddingTop: 15, borderTopWidth: 1, borderTopColor: '#F3F4F6', textAlign: 'center' },
  footerText: { fontSize: 8, color: '#6B7280', fontWeight: 'medium', textTransform: 'uppercase', letterSpacing: 2, marginBottom: 6 },
